...
namespace KmyTarkovConfiguration.Models
{
    internal class SettingsModel
    {
        ...
        private static void SwitchLanguageFromGame(string gameLanguage)
        {
            ...
            // Normaliza: lowercase e corta para 2 letras (ex: "Portuguese" -> "pt", "ENGLISH" -> "en")
            ...
            switch (normalized)
            {
                ...
                default:
                    if (!LocalizedHelper.LanguageNamesDictionary.TryGetValue(normalized, out var lang))
                        lang = "En"; // fallback seguro: nunca lança excecao
